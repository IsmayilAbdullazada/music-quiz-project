...
class HorizontalTrackAdapter(private val onTrackClicked: (Track) -> Unit) :
    ListAdapter<Pair<PlaylistTrack, Track?>, HorizontalTrackAdapter.HorizontalTrackViewHolder>(DiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HorizontalTrackViewHolder {
        ...
        return HorizontalTrackViewHolder(binding, onTrackClicked)
    }
    ...
    inner class HorizontalTrackViewHolder(private val binding: ItemHorizontalTrackBinding, private val onTrackClicked: (Track) -> Unit) :
